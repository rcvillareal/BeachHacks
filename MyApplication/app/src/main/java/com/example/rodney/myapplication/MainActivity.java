...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setTypeface(xenotronFont);
        ...
        previousTimesButton = (Button) findViewById(R.id.previousTimesButton);
        previousTimesButton.setTypeface(xenotronFont);

        previousTimesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, PreviousTimesActivity.class);
                startActivity(intent);
            }
        });
